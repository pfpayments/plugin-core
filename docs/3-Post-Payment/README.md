...
By the end of this chapter you can capture or void an authorization, refund all or part of it without floating-point drift, and fetch the official PDFs the PostFinanceCheckout Portal generates.
...
- **[Document](Document.md)** — Retrieving the official PDFs the PostFinanceCheckout Portal generates: invoices, packing slips, and credit notes.
