 ...
 *
 * The PostFinanceCheckout Portal uses this to tell integrations apart: which platform a request came
...
readonly class ClientMetadata
{
     ...
     *
     * Patch releases are dropped deliberately: the PostFinanceCheckout Portal groups installations by
