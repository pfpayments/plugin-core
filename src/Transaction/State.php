...
use PostFinanceCheckout\PluginCore\State\ValidatesStateTransitions;
...
enum State: string
{
     ...
     * whether the PostFinanceCheckout Portal has invoiced or fulfilled the order yet.
     */
    ...
    /**
     * Whether the PostFinanceCheckout Portal has generated an invoice document that can be downloaded.
     *
    ...
    /**
     * Whether the PostFinanceCheckout Portal has generated a packing slip that can be downloaded.
     *
     ...
     *
     * While AUTHORIZED, the PostFinanceCheckout Portal has not generated its own invoice yet, so
     * the shop's local bookkeeping can still freely create or cancel one.
     * Once COMPLETED, the PostFinanceCheckout Portal's invoice takes over and local manipulation
     * is no longer safe.
     */
