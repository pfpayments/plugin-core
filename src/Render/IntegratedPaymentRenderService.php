...
namespace PostFinanceCheckout\PluginCore\Render;
...
<script{$nonceAttr}>
    window.__postfinancecheckoutHandlers = window.__postfinancecheckoutHandlers || {};
HTML;
    ...
    window.__postfinancecheckoutHandlers['{$data->paymentMethodConfigurationId}'] = handler;
...
HTML;
    ...
    window.__postfinancecheckoutHandlers['{$data->paymentMethodConfigurationId}'] = window.LightboxCheckoutHandler;
