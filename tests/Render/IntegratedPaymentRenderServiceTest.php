...
namespace PostFinanceCheckout\PluginCore\Tests\Render;

use PHPUnit\Framework\TestCase;
use PostFinanceCheckout\PluginCore\Render\IntegratedPaymentRenderService;
use PostFinanceCheckout\PluginCore\Render\PaymentIntegrationData;
...
class IntegratedPaymentRenderServiceTest extends TestCase
{
    ...
    public function testRenderHtmlIframe(): void
    {
        ...
        $this->assertStringContainsString('window.__postfinancecheckoutHandlers = window.__postfinancecheckoutHandlers || {};', $html);
        $this->assertStringContainsString("window.__postfinancecheckoutHandlers['456'] = handler;", $html);
    ...
    public function testRenderHtmlLightbox(): void
    {
        ...
        $this->assertStringContainsString('window.__postfinancecheckoutHandlers = window.__postfinancecheckoutHandlers || {};', $html);
        $this->assertStringContainsString("window.__postfinancecheckoutHandlers['789'] = window.LightboxCheckoutHandler;", $html);
    }
    ...
    public function testRenderJsWithNonce(): void
    {
        ...
        $this->assertStringContainsString('window.__postfinancecheckoutHandlers', $js);
