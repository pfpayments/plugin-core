...
namespace PostFinanceCheckout\PluginCore\GlobalData\LabelDescriptor;
...
/**
 * Value Object representing one label descriptor the PostFinanceCheckout Portal defines.
 *
 ...
 * it is what a {@see \PostFinanceCheckout\PluginCore\Charge\Attempt\Label}'s
 ...
 * {@see \PostFinanceCheckout\PluginCore\Charge\Attempt\ChargeAttempt::getLabel()}'s
 * job.
 *
 ...
 * {@see \PostFinanceCheckout\PluginCore\LabelDescriptorGroup\LabelDescriptorGroup}.
...
readonly class LabelDescriptor
{
     ...
     *        {@see \PostFinanceCheckout\PluginCore\Charge\Attempt\Label::$descriptorId}
     *        refers to.
