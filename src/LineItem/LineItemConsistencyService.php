...
class LineItemConsistencyService
{
    ...
    public function ensureConsistency(
        ...
        if (!$this->settings->isLineItemConsistencyEnabled()) {
            $this->logger->warning(
                "Line item discrepancy detected but consistency enforcement is DISABLED. Proceeding with mismatched totals; the PostFinanceCheckout API will likely reject this request or hide payment methods.",
                [
