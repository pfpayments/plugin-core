 ...
 *
 * NOTE: An indication only exists once the payment is captured AND the PostFinanceCheckout Portal
...
use PostFinanceCheckout\PluginCore\DeliveryIndication\DeliveryIndicationService;
