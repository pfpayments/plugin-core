...
2.  **Credentials:** You need a PostFinanceCheckout Space ID, User ID, and API Secret.
...
Retrieves the final Payment Page URL for the updated transaction. Open the resulting link in your browser to see the PostFinanceCheckout payment page.
