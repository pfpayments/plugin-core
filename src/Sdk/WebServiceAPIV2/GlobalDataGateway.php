...
use PostFinanceCheckout\PluginCore\Sdk\CurrencyMapperTrait;
use PostFinanceCheckout\PluginCore\Sdk\LabelDescriptorGroupMapperTrait;
use PostFinanceCheckout\PluginCore\Sdk\LabelDescriptorMapperTrait;
...
use PostFinanceCheckout\Sdk\Model\LabelDescriptorGroupSearchResponse as SdkLabelDescriptorGroupSearchResponse;
use PostFinanceCheckout\Sdk\Model\LabelDescriptorSearchResponse as SdkLabelDescriptorSearchResponse;
use PostFinanceCheckout\Sdk\Model\LanguageListResponse as SdkLanguageListResponse;
use PostFinanceCheckout\Sdk\Model\PaymentConnector as SdkPaymentConnector;
use PostFinanceCheckout\Sdk\Model\PaymentConnectorSearchResponse as SdkPaymentConnectorSearchResponse;
use PostFinanceCheckout\Sdk\Model\RestApiErrorResponse as SdkRestApiErrorResponse;
...
use PostFinanceCheckout\Sdk\Service\CurrenciesService as SdkCurrenciesService;
use PostFinanceCheckout\Sdk\Service\LabelDescriptorsService as SdkLabelDescriptorsService;
use PostFinanceCheckout\Sdk\Service\LanguagesService as SdkLanguagesService;
use PostFinanceCheckout\Sdk\Service\PaymentConnectorsService as SdkPaymentConnectorsService;

/**
 * Gateway for retrieving the PostFinanceCheckout Portal's global reference data using the SDK.
 *
 * This data is global to the PostFinanceCheckout Portal, so no call here is space-scoped. Unlike most
