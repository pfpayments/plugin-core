...
class Settings
{
    ...
    public function getSpaceId(): int
    {
        ...
        if (empty($value)) {
            throw new \InvalidArgumentException('PostFinanceCheckout Space ID is missing or invalid.');
        }
        return (int) $value;
    }
    ...
    public function getUserId(): int
    {
        ...
        if (empty($value)) {
            throw new \InvalidArgumentException('PostFinanceCheckout User ID is missing or invalid.');
        }
        return (int) $value;
    }
    ...
    public function getApiKey(): string
    {
        ...
        if (empty($value)) {
            throw new \InvalidArgumentException('PostFinanceCheckout API Key is missing or invalid.');
        }
        return (string) $value;
    }
