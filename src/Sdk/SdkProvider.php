...
class SdkProvider
{
     ...
     * reads non-space-scoped data — the PostFinanceCheckout Portal's global reference data, say — can
     ...
     *
     * A connection error means the request never reached the PostFinanceCheckout
     * PostFinanceCheckout Portal: nothing was processed, so replaying it is safe and is expected to
