...
namespace PostFinanceCheckout\PluginCore\GlobalData\Language;

use PostFinanceCheckout\PluginCore\SharedKernel\JsonStringableTrait;

/**
 * Value Object representing one language the PostFinanceCheckout Portal supports.
 *
 ...
 * the PostFinanceCheckout Portal accepts.
 *
