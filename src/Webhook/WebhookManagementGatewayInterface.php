 ...
 *
 * Defines the contract for managing webhook URLs and listeners in the PostFinanceCheckout Portal.
 */
interface WebhookManagementGatewayInterface
{
    /**
    ...
    /**
     * Creates a webhook URL definition in the PostFinanceCheckout Portal.
     *
    ...
    /**
     * Lists webhook listeners in the PostFinanceCheckout Portal.
     *
     * @param int $spaceId
     * @return WebhookListenerCollection
     */
    ...
    /**
     * Lists webhook URL definitions in the PostFinanceCheckout Portal.
     *
     * @param int $spaceId
     * @return WebhookUrlCollection
     */
