...
use PostFinanceCheckout\PluginCore\Transaction\TransactionEnvironment;
use PostFinanceCheckout\PluginCore\Transaction\TransactionPaymentMethod;
...
use PostFinanceCheckout\Sdk\Model\CustomersPresence as SdkCustomersPresence;
use PostFinanceCheckout\Sdk\Model\FailureReason as SdkFailureReason;
use PostFinanceCheckout\Sdk\Model\LineItem as SdkLineItemResponse;
...
use PostFinanceCheckout\Sdk\Model\PaymentMethodConfigurationListResponse;
use PostFinanceCheckout\Sdk\Model\PaymentMethodConfigurationSearchResponse as SdkPaymentMethodConfigurationSearchResponse;
...
class TransactionGatewayTest extends TestCase
{
     ...
     * using a colon separator as required by PostFinanceCheckout API V2.
     *
     * @return void
     */
    ...
    {
        $spaceId = 123;
        $criteria = new \PostFinanceCheckout\PluginCore\Transaction\TransactionSearchCriteria();
