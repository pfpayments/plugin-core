...
namespace PostFinanceCheckout\PluginCore\GlobalData\Currency;

use PostFinanceCheckout\PluginCore\SharedKernel\JsonStringableTrait;

/**
 * Value Object representing one currency the PostFinanceCheckout Portal supports.
 *
 ...
 * validating a shop's configured currency against what the PostFinanceCheckout Portal accepts.
 *
...
readonly class Currency
{
     ...
     *        (e.g. 'BHD') use 3 — see {@see \PostFinanceCheckout\PluginCore\GlobalData\Currency\CurrencyRoundingService}
