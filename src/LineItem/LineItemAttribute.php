...
use PostFinanceCheckout\PluginCore\SharedKernel\StringSanitizer;

/**
 * Custom attribute attached to a {@see LineItem}.
 *
 * The PostFinanceCheckout Portal renders attributes as `label: value` pairs (e.g. "Size: M"), so
...
class LineItemAttribute
{
    ...
    /**
     * @param string $id PostFinanceCheckout Portal-side attribute identifier (e.g. "option_144"),
