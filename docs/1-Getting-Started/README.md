...
Everything you need before your first API call: installing the library, wiring it to your PostFinanceCheckout Portal credentials, and learning the two conventions the rest of the documentation assumes you know.
...
- **[Global Data](GlobalData.md)** — The PostFinanceCheckout Portal's own lookup lists (currencies, languages, payment connectors, label descriptors), none of which take a space ID.
