...
// Install the webhook configuration (URL and Listener) in the PostFinanceCheckout Portal.
...
// Deleting only the listeners would leave the URL registered in the PostFinanceCheckout Portal,
