...
namespace PostFinanceCheckout\PluginCore\GlobalData\LabelDescriptorGroup;
 ...
 * {@see \PostFinanceCheckout\PluginCore\LabelDescriptor\LabelDescriptor}), and
 * is what a {@see \PostFinanceCheckout\PluginCore\Charge\Attempt\Label}'s
 * `groupId` refers to. Resolving a group's display name is what this service
 * is for; grouping labels themselves is
 * {@see \PostFinanceCheckout\PluginCore\Charge\Attempt\ChargeAttempt::getLabelsByGroup()}'s
 * job.
 *
