...
use PostFinanceCheckout\PluginCore\ManualTask\ManualTaskService;
use PostFinanceCheckout\PluginCore\ManualTask\State;
use PostFinanceCheckout\PluginCore\Sdk\WebServiceAPIV2\ManualTaskGateway;
...
try {
    ...
    if ($total === 0) {
        ...
        echo PHP_EOL
            . "Zero manual tasks reported. If the PostFinanceCheckout Portal lists some," . PHP_EOL
            ...
            . "  2. Space — the PostFinanceCheckout Portal view may be scoped to a" . PHP_EOL
