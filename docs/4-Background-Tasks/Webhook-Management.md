...
The Webhook Management module allows developers to programmatically manage webhook subscriptions in the PostFinanceCheckout Portal and validate incoming payloads.

## Overview

A webhook consists of two parts in the PostFinanceCheckout Portal:

1. **Webhook URL**: The endpoint where the PostFinanceCheckout Portal will send notifications.
