 ...
 *
 * A token is the PostFinanceCheckout Portal's reference to a customer's stored payment credentials.
 * It is the long-lived handle a plugin keeps against a customer; the credentials
 * themselves live in the PostFinanceCheckout Portal and are never exposed here.
 *
...
readonly class Token
{
     ...
     *        by the PostFinanceCheckout Portal. This is the key to filter by when listing one customer's
