...
use PostFinanceCheckout\PluginCore\Webhook\WebhookListener as WebhookListenerDto;
...
class WebhookServiceTest extends TestCase
{
    ...
    public function testGetWebhookUrls(): void
    {
        $spaceId = 123;
        $state = 'INACTIVE';
        $expectedUrls = [new \PostFinanceCheckout\PluginCore\Webhook\WebhookUrl(1, 'Test', 'url', 1)];
