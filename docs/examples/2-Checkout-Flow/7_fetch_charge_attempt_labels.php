...
// Reading one specific label: replace 1001 with a descriptor ID from your PostFinanceCheckout Portal.
$singleLabel = $chargeAttempt->getLabel(1001);
echo "\nLabel 1001: " . ($singleLabel?->content ?? 'not present on this attempt') . "\n";

// Reading every label of one group: replace '4' with a group ID from your PostFinanceCheckout Portal.
