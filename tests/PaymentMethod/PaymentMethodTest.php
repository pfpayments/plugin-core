...
namespace PostFinanceCheckout\PluginCore\Tests\PaymentMethod;
...
class PaymentMethodTest extends TestCase
{
    ...
    {
        $method = $this->createMethodWithImageUrl('https://checkout.postfinance.ch/s/123/resource/payment/icon.svg');
    ...
    {
        $method = $this->createMethodWithImageUrl('https://checkout.postfinance.ch/images/icon.svg');

        $this->assertSame('https://checkout.postfinance.ch/images/icon.svg', $method->getRelativeImagePath());
    }
    ...
    {
        $method = $this->createMethodWithImageUrl('https://checkout.postfinance.ch/s/123/resource/payment/twint.svg?strategy=snapshot');
