...
class StateValidator
{
     ...
     * @param string $remoteState The new state reported by the PostFinanceCheckout Portal.
     ...
     * that might be introduced in the PostFinanceCheckout Portal before the plugin is updated.
     *
